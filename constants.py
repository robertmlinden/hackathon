...
CALIBRATION_PATH = os.path.join(CURRENT_PATH, 'calibration')
...
TRACKERSERIALNUMBER = 'IS404-100108221063'
# EyeLink only
# SMI only
SMIIP = '127.0.0.1'
SMISENDPORT = 4444
...
SCREENDIST = 57 # cm, IDK what this does, but it's somehow helpful
